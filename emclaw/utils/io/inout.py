...
# Placeholder for a post-calculation function
...
class IO(object):
    ...
    def read_petsc(self):
        ...
        # Read PETSc data from pickle and binary files
    ...
    def __init__(self, frame=0, file_prefix='claw', path='./', write_aux=False, write_p=False, read_aux=False):
        # Initialize IO object with provided parameters
        self.frame = frame
